	...
	SubShader
	{
		...
		Pass
		{
			...
			VertexOutput VertexFunction ( VertexInput v  )
			{
				...
				o.ase_texcoord5 = vertexToFrag104;
				...
				o.ase_texcoord6 = vertexToFrag108;
				float3 vertexToFrag92 = ase_worldNormal;
				o.ase_texcoord8.xyz = vertexToFrag92;
				float3 vertexToFrag93 = v.vertex.xyz;
				o.ase_texcoord9.xyz = vertexToFrag93;
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float3 worldPosition130 = IN.ase_texcoord4.xyz;
				...
				float4 vertexToFrag104 = IN.ase_texcoord5;
				float4 vertexToFrag108 = IN.ase_texcoord6;
				float2 texCoord137 = IN.ase_texcoord7.xy * _MainColorTexture_ST.xy + _MainColorTexture_ST.zw;
				...
				float3 vertexToFrag92 = IN.ase_texcoord8.xyz;
				...
				float3 vertexToFrag93 = IN.ase_texcoord9.xyz;
				...
				float3 Color = ( ( ( ( ( localMarchnerHighLight156 + localMarchnerHighLight273 ) * ase_lightAtten ) * _SpecularColor ) + ( ( saturate( ( vertexToFrag104 * ase_lightAtten ) ) + vertexToFrag108 ) * lerpResult103 ) ) + localBackLighting79 + localAdditionalLightsMarschner94 ).xyz;
				float Alpha = 1;
...
/*ASEBEGIN
Version=18935
484;72.66667;1343.333;749;2180.601;74.35809;1;True;True
...
Node;AmplifyShaderEditor.TexturePropertyNode;83;-1554.037,366.8195;Inherit;True;Property;_MainColorTexture;Main Color Texture;1;1;[Header];Create;True;1;Main Colors;0;0;False;0;False;None;None;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
...
Node;AmplifyShaderEditor.RangedFloatNode;109;2134.971,-215.0936;Inherit;False;Constant;_Float0;Float 0;9;0;Create;True;0;0;0;False;0;False;1;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TextureTransformNode;151;-2036.934,366.3085;Inherit;False;-1;False;1;0;SAMPLER2D;;False;2;FLOAT2;0;FLOAT2;1
...
ASEEND*/
//CHKSM=C2E81456F25CD4E8E4CDD0A5E758C346F14721D5